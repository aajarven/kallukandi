...
Juuririnnakkaistaminen on myös Cazenaven ym. kehittämä MCTS:n rinnakkaistusalgoritmi, jossa myös laajennettavan solmun valinta rinnakkaistetaan~\cite{cazenave, chaslot}. Menetelmä rakentaa useita pelipuita, jotka suorittavat rinnakkain toisistaan riippumatta omat puuhakunsa. Kun laskenta-aika on käytetty loppuun, koostetaan näiden pelipuiden saamista tuloksista odotusarvot juurisolmun lapsille, ja valitaan pelattava siirto sen mukaan.
