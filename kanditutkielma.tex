...
Juuririnnakkaistaminen on Cazenaven ym. kehittämä MCTS:n rinnakkaistusalgoritmi, joka suorittaa puurinnakkaistamisen tapaan täyden MCTS-algoritmin jokaisessa säikeessä~\cite{cazenave, chaslot}. Juuririnnakkaistettu MCTS tuottaa joukon pelipuita antamalla jokaiselle säikeelle oman pelipuun, jolloin poistuu puurinnakkaistamisen tarve suojata muistia samanaikaiselta käytöltä. Kun laskenta-aika on käytetty loppuun, valitaan pelipuiden tuottamien tulosten mukaan pelattava siirto.

Perinteinen ratkaisu pelattavan siirron valintaan pelipuujoukon perusteella on valita pelipuissa yhteenlasketusti eniten tutkittu solmu~\cite{browne}, mutta Soejima ym. esittelevät vaihtoehtoisen strategian, jossa siirto valitaan enemmistöäänestyksellä~\cite{soejima}. Enemmistöäänestys valitsee siirron, joka on useimman pelipuun eniten vierailtu solmu.
